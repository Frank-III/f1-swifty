...
//@MainActor
//@Observable
//final class OriginalTrackMapViewModel {
//    // MARK: - Properties
//    
...
//            print("TrackMap: No position data available: \(String(describing: appEnvironment.liveSessionState.positionData))")
//            print("  - positionData exists: \(appEnvironment.liveSessionState.positionData != nil)")
//            if let positionData = appEnvironment.liveSessionState.positionData {
//              print("  - position entries count: \(positionData.position?.count ?? 0)")
//            }
//            return []
//        }
//        
//        print("TrackMap: Found position data with \(latestPosition.entries.count) entries")
//        
...
//        
//        // Add regular drivers
//        print("TrackMap: Processing \(latestPosition.entries.count) position entries")
//        var processedDrivers = 0
//        var skippedDrivers = 0
//        
//        for (racingNumber, carPos) in latestPosition.entries {
//            let hasDriver = appEnvironment.liveSessionState.driver(for: racingNumber) != nil
//            let isNotExcluded = !["-1", "241", "242", "243"].contains(racingNumber)
//            let hasValidPosition = carPos.x != 0 && carPos.y != 0
//            
//            print("TrackMap: Driver \(racingNumber) - hasDriver: \(hasDriver), notExcluded: \(isNotExcluded), validPos: \(hasValidPosition) (\(carPos.x), \(carPos.y))")
//            
//            guard let driver = appEnvironment.liveSessionState.driver(for: racingNumber),
//                  isNotExcluded,
//                  hasValidPosition else {
//                skippedDrivers += 1
//                continue
//            }
//            
...
//        }
//        
//        print("TrackMap: Result - processed: \(processedDrivers), skipped: \(skippedDrivers), total positions: \(positions.count)")
//        
//        return positions
//    }
//    
