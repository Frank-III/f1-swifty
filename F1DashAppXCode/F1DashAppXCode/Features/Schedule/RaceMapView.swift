...
//  F1-Dash
//
//  Interactive map view showing race locations
//
...
struct RaceMapView: View {
    ...
    @State private var showingRaceDetail: RaceRound?
    ...
    var body: some View {
        ...
        .sheet(item: $showingRaceDetail) { race in
            #if os(iOS)
        ...
        #if os(macOS)
        .popover(item: $selectedRace, attachmentAnchor: .point(.top), arrowEdge: .bottom) { race in
...
struct RaceMapMarker: View {
    ...
    private var markerColor: Color {
        RaceColorTheme.color(for: race.countryName, isActive: race.isActive, isPast: race.end < Date())
    }
